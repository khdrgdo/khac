      ...
      <CardContent className="p-4 flex gap-3 items-center">
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent className="sm:max-w-[600px] p-0 gap-0 overflow-hidden border-muted/50">
            <DialogTitle className="sr-only">إنشاء منشور</DialogTitle>
            {/* Top Tabs Header */}
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 space-y-3">
                  <RichTextEditor
                    ...
                    placeholder={
                      isQuestion
                        ? "اكتب سؤالك التعليمي هنا بالتفصيل..."
                        : "شارك نصيحة، موضوع مفيد، أو منشور عام..."
                    }
                  />
                  {imagePaths.length > 0 && (
                  ...
                  <div className="flex justify-between items-center gap-2 pt-3 border-t border-muted/40">
                    ...
                    <Button
                      ...
                      onClick={() => mut.mutate()}
                      disabled={
                        (!content.trim() && imagePaths.length === 0) ||
                        mut.isPending ||
                        hits.length > 0
                      }
