...
export function InstallPWAButton({
  ...
  const handleInstallClick = async () => {
    ...
    // Trigger download of the HTML launcher directly
  ...
  return (
    <>
      ...
      {/* Top Floating Notification Banner for Installing App */}
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="text-right min-w-0">
                ...
                <p className="text-[11px] text-purple-200/90 truncate mt-0.5">
                  ثبته كتطبيق مستقل على الشاشة الرئيسية بدون شريط متصفح!
                </p>
              </div>
            </div>
