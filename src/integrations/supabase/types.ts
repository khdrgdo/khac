...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          email: string | null
          full_name: string
          hide_university_number: boolean | null
          id: string
    ...
    Functions: {
      ...
      admin_set_teacher_role: { Args: { _user: string }; Returns: undefined }
      admin_set_user_role: {
      ...
      create_post_as: {
        Args: {
          ...
          _content: string
          _images?: string[]
          _post_type?: Database["public"]["Enums"]["post_type"]
        }
        Returns: string
      }
      delete_conversation: {
      ...
      get_anonymous_authors: {
        Args: { _ids: string[]; _type: string }
        Returns: {
          author_id: string
          avatar_url: string
          content_id: string
      ...
      get_leaderboard_profiles: {
        Args: {
          _major?: Database["public"]["Enums"]["major_code"]
          _year?: number
        }
        Returns: {
          avatar_url: string
